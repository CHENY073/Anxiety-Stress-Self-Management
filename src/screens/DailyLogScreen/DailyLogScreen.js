...
const DailyLogScreen = ({navigation}) => {
    ...
    return (
      ...
      <View style = {styles.containter}>
        ...
        <Picker selectedValue={activity} onValueChange={(itemValue, itemIndex) => setWhat(itemValue)} style = {styles.picker} numberOfLines={5}>
        ...
        <Picker selectedValue={triggers} onValueChange={(itemValue, itemIndex) => setWho(itemValue)} style = {styles.picker} numberOfLines={5}>
        ...
        <Picker selectedValue={signs} onValueChange={(itemValue, itemIndex) => setWhen(itemValue)} style = {styles.picker} numberOfLines={5}>
        ...
        <Picker selectedValue={anxietyLevel} onValueChange={(itemValue, itemIndex) => setWhere(itemValue)} style = {styles.picker} numberOfLines={5}>
        ...
        <Picker selectedValue={strategies} onValueChange={(itemValue, itemIndex) => setWhy(itemValue)} style = {styles.picker} numberOfLines={5}>
