...
const Slider = ({value, setValue, showImages}) => {
  ...
  const icon3 = '../../../assets/images/Icon3.png';
  const icon4 = '../../../assets/images/Icon4.png';
  const icon5 = '../../../assets/images/Icon5.png';
  const imgSize = 15;
  const imgAttributes = {['width']: imgSize, ['height']: imgSize, ['x']: 14-imgSize/2, ['y']: 18-imgSize/2, ['origin']: '14, 18'};
      ...
      <Svg height={size/2+size/20} width={size}>
        <G scale={size/100} y="20" origin="0, -20">
          <G onPress={() => handle(1)} rotation="0" origin="50, 30">
            ...
            {showImages? <Image href={require(icon1)} rotation="-0" {...imgAttributes}/> : <></>}
          </G>
          <G onPress={() => handle(2)} rotation="36" origin="50, 30">
            ...
            {showImages? <Image href={require(icon2)} rotation="-36" {...imgAttributes}/> : <></>}
          </G>
          <G onPress={() => handle(3)} rotation="72" origin="50, 30">
            ...
            {showImages? <Image href={require(icon3)} rotation="-72" {...imgAttributes}/> : <></>}
          </G>
          <G onPress={() => handle(4)} rotation="108" origin="50, 30">
            ...
            {showImages? <Image href={require(icon4)} rotation="-108" {...imgAttributes}/> : <></>}
          </G>
          <G onPress={() => handle(5)} rotation="144" origin="50, 30">
            ...
            {showImages? <Image href={require(icon5)} rotation="-144" {...imgAttributes}/> : <></>}
          </G>
